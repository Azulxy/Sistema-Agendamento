...
public class ConsultaView extends javax.swing.JFrame {
     ...
     */
    public ConsultaView(ArrayList<Paciente> listaPacientes, InicialView inicialView) {
        initComponents();
        this.inicialView = inicialView; // Atribua a instância de inicialView ao campo da classe
        controller = new ConsultaController(this, listaPacientes, inicialView); 
}
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ConsultaView(listaPacientes, inicialView).setVisible(true);
            }
        });
    }
